    ...
    <Main>
      <Container className="container-about-us">
        <Card className="card-about-us">
          ...
          <Container className="container-fluid d-flex justify-content-center col-md-6 about-us">
            
            <Card className="cards card-mission card-img-top" style={{ width: "15rem" }}>
            ...
            <Card className = "cards card-vision card-img-top" style={{ width: "15rem" }}>
              <Card.Body className="col-md-12">
            ...
            <Card className = "cards card- card-img-top" style={{ width: "15rem" }}>
              <Card.Body className="col-md-12">
